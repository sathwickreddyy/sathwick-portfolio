export const CLIENTS_SECTION_TITLE = "Hear from my Peers";
export const CLIENTS_STAR_IMAGE_SRC = "/sathwick-portfolio/assets/star.png";
export const CLIENTS_STAR_ALT_TEXT = "star";
