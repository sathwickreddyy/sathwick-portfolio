...
export const PROJECT_SECTION_ARROW_LEFT_IMAGE = "/assets/left-arrow.png";
export const PROJECT_SECTION_ARROW_LEFT_ALT_TEXT = "arrow-left";
export const PROJECT_SECTION_ARROW_RIGHT_IMAGE = "/assets/right-arrow.png";
export const PROJECT_SECTION_ARROW_RIGHT_ALT_TEXT = "arrow-right";
export const PROJECT_SECTION_ARROW_UP_IMAGE = "/assets/arrow-up.png"
